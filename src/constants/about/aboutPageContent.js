...
export const aboutPageContent = {
  ...
  OUR_PHILOSOPY: "Our Philosophy",
  OUR_PHILOSOPY_SUB_TITLE:
    "Attention to detail combined with the finest craftsmanship and quality.",
  OUR_PHILOSOPY_PARA_1:
    "At Stalwart Real Estate, precision meets purpose. We represent property with intention, combining strategic insight, design awareness, and disciplined execution to achieve outcomes defined by quality and integrity.",
  OUR_PHILOSOPY_PARA_2:
    "Our focus is to help clients maximise the value of their property assets through intelligent advice, refined presentation, and measured negotiation. We believe that every property deserves individual attention — where process, marketing, and communication are thoughtfully aligned to achieve the best possible result.",
  OUR_PHILOSOPY_PARA_3:
    "Every detail matters, and every interaction reflects our commitment to clarity, trust, and craftsmanship. From the first conversation to settlement, our approach is deliberate, transparent, and built on genuine care for our clients and their homes.",
  MEET_OUR_TEAM_TITLE: "Meet Our Team",
  MEET_OUR_TEAM_PARA: [
    "Behind every Stalwart campaign is a team driven by precision, integrity, and care. We are a collective of real estate professionals who believe that success begins with preparation, and that every property deserves thoughtful attention and disciplined execution.",
    "Our people bring together deep market knowledge, design awareness, and a commitment to clear communication. We take pride in relationships built on trust, and in outcomes that speak for themselves — refined, confident, and crafted to last",
  ],
  teamMembers: [
    {
      id: 1,
