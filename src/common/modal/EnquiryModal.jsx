...
const EnquiryModal = ({
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-12.5 lg:px-0"
      onClick={handleCancel}
    >
      <div
        className="bg-[#F4F2F0] w-full max-w-[1400px] h-full xl:h-[775px] relative overflow-y-auto"
