...
const ThankyouPage = () => {
  ...
  return (
    <div className="bg-white h-screen -mt-20 flex flex-col gap-4 justify-center items-center">
      <p className="uppercase text-xl font-monument">Thank You</p>
      ...
      <div className="mt-12 flex  gap-4">
        <Link to={URLS.HOME} className="cursor-pointer">
          <button
            className="mt-4 px-6 py-2 border-black border text-black font-semibold uppercase cursor-pointer"
